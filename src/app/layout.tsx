...
export const metadata = {
  title: "Time Master",
  description:
    "Plataforma para gestión de precios, escaneo de códigos de barras, control de inventario y horarios laborales",
  icons: {
    icon: [
  ...
  authors: [{ name: "AndersFloresM" }, { name: "AlvaroChavesC" }],
