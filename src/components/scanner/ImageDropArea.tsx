...
export default function ImageDropArea({
  ...
  return (
    <div>
      ...
      <div
        className={`relative border-4 border-dashed rounded-3xl p-10 transition-all duration-300 cursor-pointer hover:border-[var(--primary)] bg-[var(--background)] dark:bg-zinc-900/70 shadow-xl group ${
          recentPaste
