...
export default function MobileScanHelp({
  mobileUrl,
  sessionId,
}: MobileScanHelpProps) {
    ...
    <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4 text-sm">
      ...
      <div className="space-y-3 text-blue-800 dark:text-blue-200">
        ...
        <div className="flex gap-3">
          ...
          <div>
            <strong>Escanea códigos de barras</strong> con la cámara de tu móvil
            o introduce códigos manualmente.
          </div>
        </div>
        <div className="flex gap-3">
          <span className="flex-shrink-0 w-6 h-6 bg-blue-600 text-white rounded-full flex items-center justify-center text-xs font-bold">
          ...
          <div>
            Los códigos aparecerán <strong>automáticamente aquí</strong> en
            tiempo real. <Bell className="w-4 h-4 inline text-orange-500" />
          </div>
        </div>
      </div>
      ...
      <div className="mt-4 p-3 bg-blue-100 dark:bg-blue-800/50 rounded-lg">
        ...
        <p className="text-xs text-blue-700 dark:text-blue-300">
          Asegúrate de que ambos dispositivos estén conectados a internet. Los
          códigos se sincronizan instantáneamente.
        </p>
      </div>
