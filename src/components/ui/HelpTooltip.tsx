  ...
  return (
    <div className="relative inline-block text-left">
      ...
      >
        ...
        <span
          className="text-blue-900 dark:text-blue-900 font-extrabold drop-shadow-lg animate-pulse"
          style={{ textShadow: "0 2px 8px #fff, 0 0 2px #facc15" }}
        >
          Instrucciones
        </span>
      </button>
      {open && (
        <div
          className="absolute z-[9999] mt-2 right-0 w-80 max-w-xs bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-700 rounded-lg shadow-lg p-4 text-sm text-gray-900 dark:text-gray-100"
