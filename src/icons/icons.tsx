...
function createIcon(
  render: (
    props: Required<Pick<IconProps, "color" | "strokeWidth">>,
  ) => React.ReactNode,
...
export const foodandsoda = createIcon(
  ({ color, strokeWidth }) => (
    <path
      fill={color}
...
export function resolveCustomIcon(name: string) {
  return (
    CustomIcons as Record<string, React.ComponentType<IconProps> | undefined>
  )[name];
}
